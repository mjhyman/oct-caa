...
% CAA6
fout = '/projectnb/npbssmic/ns/CAA/caa6/caa6_rgb.mat';
save(fout,'caa6','-v7.3');
% CAA17
fout = '/projectnb/npbssmic/ns/CAA/caa17/occip/caa17_rgb.mat';
save(fout,'caa17','-v7.3');
% CAA22
fout = '/projectnb/npbssmic/ns/CAA/caa22/caa22_rgb.mat';
save(fout,'caa22','-v7.3');
% CAA25
fout = '/projectnb/npbssmic/ns/CAA/caa25/caa25_rgb.mat';
save(fout,'caa25','-v7.3');
% CAA26
fout = '/projectnb/npbssmic/ns/CAA/caa26/caa26_rgb.mat';
save(fout,'caa26','-v7.3');

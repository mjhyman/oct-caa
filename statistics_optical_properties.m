...
for ii = 1:length(subs)
    ...
    for j = 1:length(regions)
        ...
        reg = regions{j};
        fprintf('abds');
        % retrieve optical properties (vessels 
    end
end

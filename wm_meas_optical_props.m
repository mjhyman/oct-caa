function [pmus, pret] = wm_meas_optical_props(seg,mus,ret,th,thick,zvox,se)
...
%   th (uint): minimum voxel intensity for WM in retardance
...
%%% Retardance
% TODO: recalculate the retardance top/bottom slices

% Threshold retardance for white matter
ret(ret < th) = 0;
% Subset of retardance corresponding to segmentation
pret = ret(:,:,slice_top:slice_bot);
